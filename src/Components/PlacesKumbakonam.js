...
const PlacesKumbakonam = () => {
  return (
    <Container className='my-5'>
    <h2 className='text-center h2'>Kumbakonam</h2>
    <h3 className='text-center h3'>Tourist Places Visit</h3>

    <Row className='mt-5'>
        <Col lg={2}>
            <img src={require('../assets/Home/kumbakonam1 (1).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
        </Col>
        <Col lg={10} className='p-2'>
            <h5 className='fw-bold'>Sarangapani Temple, Overview</h5>
            <div >
            <p style={{textAlign:'justify',textIndent:'4rem'}}>
            Sarangapani Temple, 2n ancient temple dedicated to Lord Vishnu, is located in the town of Kumbakonam in the South-indian state of
...
regarded as one of the five sacred temples
    ...
    <Row className='mt-5'>
        ...
        <Col lg={10} className='p-2'>
            <h5 className='fw-bold'>Nageswaran Temple, Overview</h5>
            <div >
            <p style={{textAlign:'justify',textIndent:'4rem'}}>
...
will only let in sunlight during the month of March-April
            ...
            <p style={{textAlign:'justify',textIndent:'4rem'}}>
            There are many inscriptions associated with the temple indicating contributions from Cholas, Thanjavur Nayaks and Thanjavur Maratha
...
ofthe largest in the state and it houses three gateway towers known as gopurams.
        ...
        <Col lg={2}>
            <img src={require('../assets/Home/kumbakonam1.(2).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
        </Col>
    </Row>

    <Row className='mt-5'>
        <Col lg={2}>
            <img src={require('../assets/Home/kumbakonam1 (3).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
        </Col>
        <Col lg={10} className='p-2'>
            <h5 className='fw-bold'>Adi Kumbeshwara Temple, Overview</h5>
            <div >
            <p style={{textAlign:'justify',textIndent:'4rem'}}>
...
Airavatesvara Temple, Overview</h5>
           <div >
           <p style={{textAlign:'justify',textIndent:'4rem'}}>
...
Vayu, Brahma, Surya, Vishnu, Saptamtrikas, Durga, Saraswat, Sr devi (Lakshmi), Ganga, Yamuna, Subrahmanya, Ganesha, Kama, Rati and others.
       ...
       <Col lg={2}>
           <img src={require('../assets/Home/kumbakonam1 (4).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
       </Col>
   </Row>
   </Container>
  )
...
export default PlacesKumbakonam